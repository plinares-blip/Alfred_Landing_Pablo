...
export function ExpressCTA() {
    return (
        <section className="w-full bg-[#111E3E] py-24 relative z-20 overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-[#0E1726] to-transparent z-10 pointer-events-none" />
            ...
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-12 relative z-20">
                <div className="w-full md:w-[60%] space-y-4">
                    ...
                    >
                        ¿Necesitas ayuda? <br />
                        <span className="text-alfred-lime">Cotiza Rápidamente.</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, x: -20 }}
                        whileInView={{ opacity: 1, x: 0 }}
                    ...
                    >
                        Pregúntale a un experto Alfred por WhatsApp. Te damos una solución sin compromiso.
                    </motion.p>
                </div>
                ...
                <div className="w-full md:w-[40%] flex justify-center md:justify-end">
                    ...
                    >
                        ...
                        <span className="text-white font-bold tracking-tight text-lg uppercase">Hablar por WhatsApp</span>
                    </motion.a>
                </div>
            </div>
        </section>
