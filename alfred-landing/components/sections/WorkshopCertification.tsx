...
export function WorkshopCertification() {
    return (
        <section id="workshop-certification" className="pb-24 pt-16 bg-gradient-to-b from-[#0E1726] via-[#111E3E] to-[#111E3E] from-0% via-10% relative overflow-hidden transition-all duration-700">
            <div className="container mx-auto px-4 relative z-10">
                <motion.div
                    ...
                    className="relative w-full h-auto md:min-h-0 md:aspect-[21/9] md:h-[550px] rounded-[2.5rem] overflow-hidden border border-white/5 shadow-2xl group bg-[#0c1222] py-8 md:py-0"
                >
                    ...
                    <div className="relative h-full container mx-auto px-6 md:px-16 flex flex-col justify-center z-10">
                        <div className="max-w-2xl space-y-6 md:space-y-8">
                            <h3 className="text-4xl md:text-7xl font-black text-white leading-[0.9] uppercase tracking-tighter">
                                Solo los mejores <br />
                                <span className="text-alfred-lime">tocan tu vehículo.</span>
                            </h3>

                            <div className="max-w-xl space-y-6 md:space-y-6">
                                <p className="text-white/80 text-base md:text-2xl font-medium leading-tight">
