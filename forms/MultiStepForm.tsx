                            ...
                            <div key={step.id} className="flex items-center">
                                <div
                                    className={cn(
                                        ...
                                        index < currentStep
                                            ? 'bg-[var(--color-lime)] text-[var(--color-navy-deep)]'
                                            : index === currentStep
                                                ? 'bg-[var(--color-lime)] text-[var(--color-navy-deep)] ring-4 ring-[var(--color-lime)]/30'
                                ...
                                {index < steps.length - 1 && (
                                    <div
                                        className={cn(
                                            ...
                                            index < currentStep ? 'bg-[var(--color-lime)]' : 'bg-white/10'
                                        )}
                                    />
                                )}
                            </div>
        ...
        <div className={cn('', className)}>
            ...
            <input
                ...
                className={cn(
                    ...
                    'focus:outline-none focus:border-[var(--color-lime)] focus:ring-2 focus:ring-[var(--color-lime)]/20',
                    'transition-colors',
...
export function FormSelect({ label, options, error, hint, className = '', ...props }: SelectProps) {
    return (
        <div className={cn('', className)}>
            ...
            >
                <option value="" className="bg-[var(--color-navy)]">
                    Selecciona una opción
                </option>
                {options.map((opt) => (
                    <option key={opt.value} value={opt.value} className="bg-[var(--color-navy)]">
                        {opt.label}
                    </option>
                ))}
            </select>
